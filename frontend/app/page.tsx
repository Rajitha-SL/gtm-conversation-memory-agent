          ...
          <div className="bg-[#0F1115] border border-[#1F2229] rounded-sm w-full max-w-md p-6 font-mono text-xs relative">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setApiProvider(val);
                    setModelName(val === 'openrouter' ? 'anthropic/claude-3.5-sonnet' : 'gemini-2.5-flash');
                  }}
              ...
              <div>
                ...
                <select
                  value={['anthropic/claude-3.5-sonnet', 'google/gemini-2.5-flash', 'meta-llama/llama-3.3-70b-instruct', 'gemini-2.5-flash', 'gemini-2.5-pro', 'gemini-1.5-flash'].includes(modelName) ? modelName : 'custom'}
                  onChange={(e) => {
                ...
                {!['anthropic/claude-3.5-sonnet', 'google/gemini-2.5-flash', 'meta-llama/llama-3.3-70b-instruct', 'gemini-2.5-flash', 'gemini-2.5-pro', 'gemini-1.5-flash'].includes(modelName) && (
                  <input
                    type="text"
